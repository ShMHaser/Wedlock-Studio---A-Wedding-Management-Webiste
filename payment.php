...
<body>
                    ...
                    <div class="flex item justify-content-between">
                        <div class="flex">
                            <div class="img text-center">
                                <img src="images/13.jpg" width="450" height="150">
                            </div>
                            <div class="title">
                                <h3>Paint it Yellow</h3>
                                <div class="buttons">
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=ATqJoT8uledW83BN2RvdA4o9tptMnGw4EUVlV1na6YHhKgqXEHcJXE8t0EZLGsDr4mybfMJ5nXxL10vQ&disable-funding=credit,card"></script>
